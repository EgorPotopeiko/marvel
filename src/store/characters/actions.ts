...
export const getCharacterStartAction: any = createAction(CharactersActionTypes.GET_CHARACTER_START)
export const getCharacterSuccessAction: any = createAction(CharactersActionTypes.GET_CHARACTER_SUCCESS)
export const getCharacterErrorAction: any = createAction(CharactersActionTypes.GET_CHARACTER_ERROR)