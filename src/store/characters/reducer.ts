...
const {
  getAllCharactersStartAction,
  getAllCharactersSuccessAction,
  getAllCharactersErrorAction,
  getCharacterErrorAction,
  getCharacterStartAction,
...
export default createReducer(initialState, {
  ...
  [getAllCharactersSuccessAction]: function (
  ...
  [getAllCharactersErrorAction]: function (
    state: TCharacterState,
    action: ActionTypes
  ) {
  ...
  [getCharacterSuccessAction]: function (
    state: TCharacterState,
    action: ActionTypes
  ) {
  ...
  [getCharacterErrorAction]: function (
    state: TCharacterState,
    action: ActionTypes
  ) {
    state.error = action.payload;
