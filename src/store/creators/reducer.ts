...
export default createReducer(initialState, {
  ...
  [getAllCreatorsSuccessAction]: function (
    state: TCreatorState,
    action: ActionTypes
  ) {
  ...
  [getAllCreatorsErrorAction]: function (
    state: TCreatorState,
    action: ActionTypes
  ) {
  ...
  [getCreatorSuccessAction]: function (
    state: TCreatorState,
    action: ActionTypes
  ) {
  ...
  [getCreatorErrorAction]: function (
    state: TCreatorState,
    action: ActionTypes
  ) {
    state.error = action.payload;
