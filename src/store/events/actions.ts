...
export const getEventStartAction: any = createAction(EventsActionTypes.GET_EVENT_START)
export const getEventSuccessAction: any = createAction(EventsActionTypes.GET_EVENT_SUCCESS)
export const getEventErrorAction: any = createAction(EventsActionTypes.GET_EVENT_ERROR)