...
const {
  getAllStoriesStartAction,
  getAllStoriesSuccessAction,
  getAllStoriesErrorAction,
  getStoryErrorAction,
  getStoryStartAction,
...
export default createReducer(initialState, {
  ...
  [getAllStoriesSuccessAction]: function (
    state: TStoriesState,
    action: ActionTypes
  ) {
  ...
  [getAllStoriesErrorAction]: function (
    state: TStoriesState,
    action: ActionTypes
  ) {
  ...
  [getStorySuccessAction]: function (
    state: TStoriesState,
    action: ActionTypes
  ) {
