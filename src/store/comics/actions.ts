...
export const getComicStartAction: any = createAction(ComicsActionTypes.GET_COMIC_START)
export const getComicSuccessAction: any = createAction(ComicsActionTypes.GET_COMIC_SUCCESS)
export const getComicErrorAction: any = createAction(ComicsActionTypes.GET_COMIC_ERROR)
