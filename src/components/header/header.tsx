          ...
          <Button
            onClick={() => {
              ...
              switch (window.location.pathname) {
                ...
                case "/comics":
                  return (
                    dispatch(setPage(1)), dispatch(getAllComicsStartAction())
                  );
                case "/creators":
                  return (
                    dispatch(setPage(1)), dispatch(getAllCreatorsStartAction())
                  );
                case "/events":
                  return (
                    dispatch(setPage(1)), dispatch(getAllEventsStartAction())
                  );
                case "/series":
                  return (
                    dispatch(setPage(1)), dispatch(getAllSeriesStartAction())
                  );
                case "/stories":
                  return (
                    dispatch(setPage(1)), dispatch(getAllStoriesStartAction())
                  );
              }
            }}
            variant="contained"
