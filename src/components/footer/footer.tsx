            ...
            <Container maxWidth='lg'>
                <div className="footer__inner">
                    <div className="footer__img">
                        <img height='130px' width='220px' src='https://gamerwall.pro/uploads/posts/2021-11/1637889849_1-gamerwall-pro-p-marvel-studiya-logotip-oboi-na-rabochii-st-1.jpg' />
                    </div>
                ...
                <div className='footer__info'>
                    ...
                    <p className="footer__info-text">Do Not Sell My Personal Information</p>
